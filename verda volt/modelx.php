...
<body scrolling="no"  >
 ...
 <ul class="submenu">
    ...
    <div id="carros" class="carousel-container">
     ...
     <button class="nav-button prev">&#10094;</button>
          <div class="carousel-slide">
            <img src="mx/carrox.jpg" alt="">
            
          </div>

          <div class="carousel-slide">
            <img src="mx/ladox.jpg" alt="">
          
          </div>

          <div class="carousel-slide">
            <img src="mx/trasx.jpg" alt="">
          
          </div>

          <div class="carousel-slide">
            <img src="mx/rodax.jpg" alt="">
          
          </div>
          
          <div  class="carousel-slide">
            <img src="mx/dentrox.jpg" alt="">
  ...
  margin-left: 1em;">  <h3> 329mi </h3> <p> 
    Alcance (EPA est.)
    </p></div>
  <div class="item" style=" gap: 2em; 
  margin-left: 1em;"><h3>149mph </h3><p>
  Velocidade máxima</p>
    </div>
  <div class="item" style=" gap: 2em; 
  margin-left: 1em;"><h3>3.8sec </h3><p>
    0-60 mph</p></div>
</div>
      <h3>Modelo</h3> <br>
