                ...
                <li class="dropdown">
                    ...
                    if(isset($_SESSION['nome'])) { ?>
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="inventario.php">Garagem</a></li>
    ...
    <div class="main-layout">
                ...
                <div class="carousel-container">
                    ...
                    <div class="carousel-track">
                        <div class="carousel-slide">
                            <img id="slide-frontal" src="mx/carrox.jpg" alt="Model X Frontal">
                        </div>
                        <div class="carousel-slide">
                            <img id="slide-lateral" src="mx/ladox.jpg" alt="Model X Lateral">
                        </div>
                        <div class="carousel-slide">
                            <img id="slide-traseira" src="mx/trasx.jpg" alt="Model X Traseira">
                        </div>
                        <div class="carousel-slide">
                            <img id="slide-rodas" src="mx/rodax.jpg" alt="Rodas">
                        </div>
                        <div class="carousel-slide">
                            <img id="slide-interior" src="mx/dentrox.jpg" alt="Interior">
                        </div>
                    </div>
        ...
        <section class="info-section">
            <div class="div-content">
                <div class="car-info">
                    <h1 class="car-title">Model X</h1>
                    <p class="car-subtitle">O SUV elétrico mais avançado</p>
                    
                    <div class="car-features">
                        <div class="feature">
                            <i class="fas fa-car"></i>
                            <h4>Portas Falcon</h4>
                            <p>Abertura vertical inovadora</p>
                        </div>
                        <div class="feature">
                            <i class="fas fa-bolt"></i>
                            <h4>Aceleração Instantânea</h4>
                            <p>0-100 km/h em 2.6 segundos</p>
                        </div>
                        <div class="feature">
                            <i class="fas fa-road"></i>
                            <h4>Alcance Estendido</h4>
                            <p>Até 560 km com uma única carga</p>
                        </div>
                        <div class="feature">
                ...
                <div class="container">
                    ...
                    <div class="section">
                        <div class="container-lado">
                            <div class="item">  
                                <h3 id="alcanceValue">560km</h3> 
                                <p>Alcance</p>
                            </div>
                            <div class="item">
                                <h3 id="velocidadeValue">262km/h</h3>
                                <p>Velocidade </p>
                            </div>
                            <div class="item">
                                <h3 id="aceleracaoValue">2.6s</h3>
                                <p>0-100 km/h</p>
                            </div>
                        </div>
                        <h3>Modelo</h3>
                    ...
                    <div id="totalPrice">R$ 74.000</div>
...
updateCarImages();
  ...
  dados.append("modelo", selectedModel + "X");
