   ...
   <div class="main-layout">
        ...
        <div class="carousel-container">
          ...
          <div class="carousel-track">
            <div class="carousel-slide">
              <img id="slide-frontal" src="m3/vendam3.jpg" alt="Model 3 Frontal">
            </div>
            <div class="carousel-slide">
              <img id="slide-lateral" src="m3/m3lado.png" alt="Model 3 Lateral">
            </div>
            <div class="carousel-slide">
              <img id="slide-traseira" src="m3/m3tras.png" alt="Model 3 Traseira">
            </div>
            <div class="carousel-slide">
              <img id="slide-rodas" src="m3/roda.png" alt="Rodas">
            </div>
            <div class="carousel-slide">
              <img id="slide-interior" src="m3/m3dentro.png" alt="Interior">
            </div>
          </div>
    ...
    <section class="info-section">
      <div class="div-content">
        <div class="car-info">
          <h1 class="car-title">Model 3</h1>
          <p class="car-subtitle">Desempenho e eficiência</p>
          
          <div class="car-features">
            <div class="feature">
              <i class="fas fa-bolt"></i>
              <h4>Aceleração Instantânea</h4>
              <p>0-100 km/h em 3.1 segundos</p>
            </div>
            <div class="feature">
              <i class="fas fa-road"></i>
              <h4>Alcance Eficiente</h4>
              <p>Até 547 km com uma única carga</p>
            </div>
            <div class="feature">
              <i class="fas fa-car"></i>
              <h4>Design Minimalista</h4>
              <p>Interior futurista e espaçoso</p>
            </div>
            <div class="feature">
              <i class="fas fa-shield-alt"></i>
              <h4>Segurança Superior</h4>
              <p>Classificação 5 estrelas</p>
            </div>
          </div>
         ...
         <div class="container">
          ...
          <div class="section">
            <div class="container-lado">
              <div class="item">  
                <h3 id="alcanceValue">547km</h3> 
                <p>Alcance</p>
              </div>
              <div class="item">
                <h3 id="velocidadeValue">225km/h</h3>
                <p>Velocidade </p>
              </div>
              <div class="item">
                <h3 id="aceleracaoValue">3.1s</h3>
                <p>0-100 km/h</p>
              </div>
            </div>
 <h3>Modelo</h3>
     ...
     <?php if(isset($_SESSION['assinante']) && $_SESSION['assinante'] == 1){ ?>
     const basePrices = {
      rwd: 50000 - 50000 * 10 / 100 ,
      long_range: 63000 - 63000 * 10 / 100,
      performance: 68000 - [(68000 * 10) / 100]
    };  <?php } else{ ?>
    ...
    const modelSpecs = {
      rwd: { alcance: '438km', velocidade: '200km/h', aceleracao: '5.8s' },
      long_range: { alcance: '547km', velocidade: '217km/h', aceleracao: '4.4s' },
      performance: { alcance: '507km', velocidade: '225km/h', aceleracao: '3.1s' }
    };
