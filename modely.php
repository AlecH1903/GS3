...
<body scrolling="no"  >
 ...
 <ul class="submenu">
    ...
    <div id="carros" class="carousel-container">
     ...
     <button class="nav-button prev">&#10094;</button>
          <div class="carousel-slide">
            <img src="my/carromy.jpg" alt="">
            
          </div>

          <div class="carousel-slide">
            <img src="my/ladomy.jpg" alt="">
          
          </div>

          <div class="carousel-slide">
            <img src="my/trasmy.jpg" alt="">
          
          </div>

          <div class="carousel-slide">
            <img src="my/rodamy.jpg" alt="">
          
          </div>
          
          <div class="carousel-slide">
            <img src="my/dentromy.jpg" alt="">
          
          </div>

          <div class="carousel-slide">
            <img src="my/dentro2.jpg" alt="">
  ...
  <div class="item" style=" gap: 2em; 
  margin-left: 1em;"><h3>5.4sec </h3><p>
    0-60 mph</p></div>
</div>
      <h3>Modelo</h3> <br>
